...
import { Plus, Edit, Trash2, Eye, Image as ImageIcon, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function BlogManagement() {
  ...
  const loadPosts = async () => {
    ...
    try {
      ...
      // Fix: Normalize dates - handle both ISO strings and plain "YYYY-MM-DD"
              ...
              {posts.slice((currentPage - 1) * POSTS_PER_PAGE, currentPage * POSTS_PER_PAGE).map((post) => (
                <tr key={post.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">
                    ...
                    {post.slug && <div className="text-xs text-gray-500">/{post.slug}</div>}
                  </td>
            ...
            <div className="flex items-center justify-between px-6 py-4 bg-gray-50 border-t">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-3 py-1 rounded bg-white border hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1"
                >
